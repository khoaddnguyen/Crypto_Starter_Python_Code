...
class Blockchain:
    ...
    def add_block(self, data):
        block = Block(data)
        #adding amount to owner and coin miners, "from" is empty
...
#assigning owner
blockchain = Blockchain("Britney Spears")
...
print("Balance of Britney Spears (owner/miner):", blockchain.get_balance("Britney Spears"), "USD")
print("Balance of Spiderman:", blockchain.get_balance("Spiderman"), "USD")
print("Balance of Taylor Swift:", blockchain.get_balance("Taylor Swift"), "USD")
